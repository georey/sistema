...
<div id='main-table-box'>
	<?php echo form_open( $insert_url, 'method="post" id="crudForm" autocomplete="off" enctype="multipart/form-data"'); ?>
		...
		<div class="pDiv">
			<p>
				<button type='submit'  class="button dodger small"> <?php echo $this->l('form_save'); ?> </button>
			
<?php 	if(!$this->unset_back_to_list) { ?>				
			
				<button type='button'  id="save-and-go-back-button"  class="button dodger small"><?php echo $this->l('form_save_and_go_back'); ?></button>
			
			
				<button type='button' onclick="javascript: goToList()"  class="button dodger small" ><?php echo $this->l('form_cancel'); ?></button>
