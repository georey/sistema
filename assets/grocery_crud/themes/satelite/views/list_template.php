...
<div class="satelite" style='width: 100%;'>
	...
	<div class="row-fluid">
		<div class="span8">
			<?php if(!$unset_add){?>
			<a class="btn btn-large" href="<?php echo $add_url?>" title="<?php echo $this->l('list_add'); ?> <?php echo $subject?>"><strong><?php echo $this->l('list_add'); ?> <?php echo $subject?></strong></a>
			<?php }?>
		</div>
		<div class="span4">
			<?php if(!$unset_export) { ?>
        	<a class="btn btn-large" href="<?php echo $export_url; ?>" target="_blank">				
			...
			<?php } ?>
			<?php if(!$unset_print) { ?>
        	<a class="btn btn-large" href="<?php echo $print_url; ?>">
        		<span class="icon16 icon-print"></span>
