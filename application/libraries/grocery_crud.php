...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function showList($ajax = false, $state_info = null, $texto=null, $funcion=null, $texto1=null, $funcion1=null)
	{
		...
		foreach($data->list as $num_row => $row)
		{
			...
			$data->list[$num_row]->custom_f = $row->{$data->primary_key};
		}
...
class grocery_CRUD extends grocery_CRUD_States
{
	...
	const	JQUERY 			= "jquery.library.1.7.2.js";		
	...
	protected $default_theme		= 'satelite';
...
//@todo ui_day, ui_month, ui_year has to be lang strings
	 ...
	 * @access	public
	 */
	public function render($texto=null, $funcion=null, $texto1=null, $funcion1=null)
	{
		$this->pre_render();
		...
		switch ($this->state_code) {
			...
			case 1://list
				...
				$this->showList(false,$state_info, $texto, $funcion, $texto1,$funcion1);
			...
			case 7://ajax_list
				...
				$this->showList(true,true, $texto, $funcion, $texto1,$funcion1);
				//version original, 
				//$this->showList(true);
