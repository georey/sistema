<table cellpadding="0" cellspacing="0" border="0" class="responsive dynamicTable display table table-bordered" width="100%">
	...
	<tbody>		
		...
		<tr>
			...
			<td>
				<a data-toggle="modal" href="#asignar" data-id="<?php echo $key['fac_id'] ?>" onclick="javascript:$('#fac_id').attr('value',$(this).attr('data-id'))" title="Asignar responsable"><span aria-hidden="true" class="icon-user"></span></a> | 
            ...
            <div class="content">               
                <form class="form-horizontal" method="POST">                    
                    <div class="form-row row-fluid">
                        <div class="span12">
                            <div class="row-fluid">
                                <label class="form-label span4" for="nombres">Responsable</label>
                                <div class="span8 controls">  
                                    <select class="span8 text" id="responsable" name="responsable">
                                        <?php foreach ($responsables as $key) { ?>
                                            <option value="<?php echo $key['res_id']?>"><?php echo $key['res_nombre'].' '.$key['res_apellido']?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
