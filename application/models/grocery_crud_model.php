...
class grocery_CRUD_Model  extends CI_Model  {
    ...
    function get_field_types_basic_table()
    {
        ...
        //print_r($this->db->query("SELECT * FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = '{$this->table_name}'")->result());
    	foreach($this->db->query("SELECT * FROM INFORMATION_SCHEMA.Columns WHERE TABLE_NAME = '{$this->table_name}'")->result() as $db_field_type)
    	{            
    		...
    		$db_field_types[$db_field_type->COLUMN_NAME]['db_extra'] = $db_field_type->COLLATION_NAME;
    	}
