...
class Auth extends CI_Controller
{
	...
	function index()
	{
		if ($message = $this->session->flashdata('message')) {
            ...
            $this->_cargarvista(array('message' => $message));
		} else {
			redirect('/auth/login/');
		}
	}
	...
	function change_password()
	{
		if (!$this->tank_auth->is_logged_in()) {								// not logged in or not activated
			...
			$this->form_validation->set_rules('confirm_new_password', 'Confirmación de Contraseña', 'trim|required|xss_clean|matches[new_password]');
		...
		if (!$this->tank_auth->is_logged_in()) {
			...
			try
			{
                ...
                $crud->display_as('username','Nombre de Usuario')
                    ...
                    ->display_as('username','Nombre de Usuario')
                    ->add_action('Restablecer Contraseña','','','pass_new',array($this,'_pass_new'))
                ;
     ...
     * @author Alexis Beltran
     */
    function _pass_new($primary_key , $row){
        return $row->username;
    }
